...
HD_PWD='C:/Users/gahme/Desktop/Pipelined_Processor/Pipelined_Processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log basys3_pipelined.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source basys3_pipelined.tcl
