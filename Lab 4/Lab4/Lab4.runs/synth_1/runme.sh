...
HD_PWD='C:/Users/gahme/Desktop/Lab4/Lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BASYS_Processor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BASYS_Processor.tcl
