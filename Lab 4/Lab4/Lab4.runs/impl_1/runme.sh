...
HD_PWD='C:/Users/gahme/Desktop/Lab4/Lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BASYS_Processor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BASYS_Processor.tcl -notrace
